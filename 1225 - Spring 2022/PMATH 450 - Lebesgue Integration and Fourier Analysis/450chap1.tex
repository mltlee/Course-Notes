...
Behaving as a physicist would, we toss the derivative into the 
integral to obtain 
...
or Riemann integrable, if we want to be more fancy. As for the boundary 
conditions, this really depends on the physical scenario. We give 
